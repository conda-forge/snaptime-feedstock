...
All platforms:
[![noarch](https://img.shields.io/circleci/project/github/conda-forge/snaptime-feedstock/master.svg?label=noarch)](https://circleci.com/gh/conda-forge/snaptime-feedstock)
...
Once the `conda-forge` channel has been enabled, `snaptime` can be installed with:

```
conda install snaptime
```

It is possible to list all of the versions of `snaptime` available on your platform with:
